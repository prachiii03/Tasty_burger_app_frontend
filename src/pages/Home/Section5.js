        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>Get exclusive deals & save up to 20%</h2>
              <p>
                Order your favorite burgers, sides, and drinks straight from
                your phone. With our mobile app, you’ll enjoy faster checkout,
                live order tracking, and special discounts you won’t find
                anywhere else.
              </p>
